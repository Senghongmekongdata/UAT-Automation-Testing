...
if __name__ == "__main__":
    ...
    if source_engine and dest_engine:
        ...
        if not source_dataframe.empty and not dest_dataframe.empty:
            ...
            # --- Reporting Section ---
            print("\n--- Data Profile Report ---")
            print(f"Source:      {len(source_dataframe)} rows, {len(source_dataframe.columns)} columns")
            print(f"Destination: {len(dest_dataframe)} rows, {len(dest_dataframe.columns)} columns")
